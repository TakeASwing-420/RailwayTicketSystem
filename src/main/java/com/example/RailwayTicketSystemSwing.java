...
public class RailwayTicketSystemSwing {
    ...
    private static final String TRAIN_DATA_FILE = "./data.xlsx";
    private static final String PASSENGER_TICKETS_FILE = "./passenger_tickets.xlsx";
    private static final String PLATFORM_TICKETS_FILE = "./platform_tickets.xlsx";
